$(document).ready(function () {
	if (JSON.parse(localStorage.getItem("items"))) {
		...
		for (var i = items.length - 1; i >= 0; i--) {
			...
			var panelWrap = $("<div class='panelWrap'><button class='left floated ui red button'>Delete</button><div class='right floated'><i class='star icon'></i><i class='check circle icon'></i></div></div>"),
